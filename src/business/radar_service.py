...
from dao.radar_dao import count_by_owner, create, get, list_by_owner, set_channels, update_scan_state
...
def get_radar(db: Session, user: User, radar_id: int):
    ...
    if radar is None or radar.owner_id != user.id or not radar.active:
